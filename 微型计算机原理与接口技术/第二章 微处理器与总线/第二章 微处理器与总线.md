...
<font color="#9bbb59">存储单元内容</font>：8086/8088 CPU的存储
...
| 2001H  | 0x34 |
|  ...   |      |
5. 16位数据存放时可以分为<font color="#c00000">规则存放</font>和<font color="#c00000">非规则存放</font>，如上表的<font color="#c00000">以偶地址开始存放的数据为规则存放</font>，其取指令只需要一个机器周期；而<font color="#c00000">以奇地址开始存放的数据为非规则存放</font>，需要两个机器周期。
