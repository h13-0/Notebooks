...
与8086/8088CPU配套的<font color="#c00000">地址锁存器</font>型号为8282/8283芯片，配套的<font color="#c00000">总线控制器</font>为8288芯片，其中8283为反向输出芯片。
...
8286三态<font color="#c00000">输出数据收发器</font>的引脚及其内部结构图如下：
