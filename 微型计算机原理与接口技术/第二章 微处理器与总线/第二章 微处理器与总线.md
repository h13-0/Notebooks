...
|   27    |      $DT/\overline{R}$       | 在最小模式系统中用来控制数据收发器8286/8287，<font color="#c00000">要配合</font> $M/\overline{IO}$ <font color="#c00000">引脚使用</font>。<br>$DT/\overline{R}$ 为高电平时，表示数据从 CPU 向外部输出，即完成写操作；<br>$DT/\overline{R}$ 为低电平时，表示数据从外部向 CPU 输入，即完成读操作。 |
|   28    |      $M/\overline{IO}$       | 指明是操作存储器还是IO设备。                                                                                                                                                                                                        |
|   29    |       $\overline{WD}$        | 写信号标志引脚，表示当前CPU正在写存储器/IO。                                                                                                                                                                                              |
|   32    |       $\overline{RD}$        | 读信号标志引脚，表示当前CPU正在读存储器/IO。                                                                                                                                                                                              |
