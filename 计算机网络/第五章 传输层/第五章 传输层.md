...
<span style="background:#fff88f"><font color="#c00000"><B>TCP连接的建立</B></font></span>
	...
	1. 客户端向服务端发送<font color="#c00000">连接请求报文段</font>，<span style="background:#fff88f"><font color="#c00000">无数据荷载</font></span>。各标志位参数为：
	...
	2. TCP服务端为该连接准备分配缓存和变量，随后发送<font color="#c00000">确认报文段</font>，<span style="background:#fff88f"><font color="#c00000">无数据荷载</font></span>，表示允许连接。各参数标志位为：
