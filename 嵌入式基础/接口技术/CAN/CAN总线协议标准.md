...
4. <span style="background:#fff88f"><font color="#c00000">在标准格式的前11位ID与拓展格式的前11位ID一致时</font></span>，<font color="#c00000">标准格式的报文优先级比拓展格式的报文高</font>，因为拓展格式的两种报文的替代远程请求(SRR)恒为1，且
5. 