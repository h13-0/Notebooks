...
## 2.24 对数组使用sizeof会得到什么结果 ^9r90wx
...
## 2.40 讲一下malloc是如何管理堆的

考查企业：
- 影石 嵌入式


## 2.41 讲一讲字符串操作(strcmp、strcat、strcpy等)
...
## 2.47 [TODO]讲一讲存储类型(auto、static、extern、register)
...
## 2.55 为什么在C语言中，一定要用unsigned char表示byte而非signed char或char
...
## 2.56 若Makefile中，头文件被修改，再次make会发生什么
...
## 2.63 void* 类型的指针作用是什么，相比于char* 、int* 等有什么优势？

考查企业：
- 影石 嵌入式


## 2.64 static和全局变量分别存储在哪里

考查企业：
- 禾塞科技 嵌入式

## 2.65 讲一下volatile关键字的作用
...
## 2.67 C的宏函数、内联函数和普通函数的区别是什么

考查企业：
- 影石 嵌软

## 2.68 讲一讲内存泄漏的排查工具及方法
