...
## 3.14 讲一下C++中动态多态和静态多态之间的区别

1. C++的动态多态是基类和派生类之间的多态，是垂直方向上的，是与类型相关的(例如用基类指针操作派生类的虚函数，那么调用的是基类版本)
2. 而C++的静态多态主要是
...
<font color="#9bbb59">静态多态</font>即<font color="#9bbb59">编译期多态</font>，其在编译阶段即明确需要调用的函数，从而省去了运行时多态的动态开销，其原理主要依靠于：
- 函数重载：
- 模板：
