...
### 2.49 为什么在C语言中，一定要用unsigned char表示byte而非signed char或char
...
### 2.50 若Makefile中，头文件被修改，再次make会发生什么
...
### 2.57 void* 类型的指针作用是什么，相比于char* 、int* 等有什么优势？

考查企业：
- 影石 嵌入式


### 2.58 static和全局变量分别存储在哪里

考查企业：
- 禾塞科技 嵌入式

### 2.59 讲一下volatile关键字的作用
