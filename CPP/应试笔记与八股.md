...
## 3.9 讲一讲动态多态的实现原理，虚表和虚指针存放在哪里

考察企业：
- 中望 C++软开

## 3.10 讲一讲智能指针，为什么要有智能指针
...
其设计的主要目的有：
1. RAII特性：即把资源的生命周期绑定到指针的声明周期上
2. 引用计数特性：共享指针内置引用计数器，当计数器归0时自动销毁该对象从而释放资源
...
## 3.12 share_ptr中哪些是线程安全的

考察企业：
- 理想汽车 系统软件开发

## 3.13 share_ptr的计数器存放在哪里
...
## 3.17 为什么要实现拷贝构造？讲一讲深拷贝和浅拷贝的区别

考察企业：
- 开立医疗 C++开发

## 3.18 返回值可以作为重载的区分条件吗

考察企业：
- 中望 C++软开

## 3.19 const和非const形参能作为重载的区分条件吗

考察企业：
- 中望 C++软开


## 3.20 引用计数有没有可能无法清零？如何解决循环引用的问题？

考察企业：
- 中望 C++软开
- 理想汽车 系统软件开发

## 3.21 STL中的sort函数使用的是什么排序

考察企业：
- 中望 C++软开

## 3.22 unordered_map和map有什么区别
...
## 3.23 迭代器的原理？为什么有了指针还要迭代器？

考察企业：
- 中望 C++软开

## 3.24 讲一讲vector和list的区别
...
## 3.27 讲一讲lambda表达式的原理

考查企业：
- 理想汽车 系统软件开发

## 3.28 lambda函数中捕获的变量存到了哪里

考察企业：
- 理想汽车 系统软件开发

## 3.29 讲一讲设计模式、以及什么是单例模式

考察企业：
- 旷视科技 自动驾驶部署优化


## 3.30 讲一下extern C及其作用
