...
## 3.11 讲一讲动态多态的实现原理，虚表和虚指针存放在哪里

考察企业：
- 中望 C++软开

## 3.12 讲一讲智能指针，为什么要有智能指针
...
## 3.14 share_ptr中哪些是线程安全的

考察企业：
- 理想汽车 系统软件开发

## 3.15 share_ptr的计数器存放在哪里
...
## 3.19 为什么要实现拷贝构造？讲一讲深拷贝和浅拷贝的区别

考察企业：
- 开立医疗 C++开发

## 3.20 返回值可以作为重载的区分条件吗

考察企业：
- 中望 C++软开

## 3.21 const和非const形参能作为重载的区分条件吗

考察企业：
- 中望 C++软开


## 3.22 引用计数有没有可能无法清零？如何解决循环引用的问题？

考察企业：
- 中望 C++软开
- 理想汽车 系统软件开发

## 3.23 STL中的sort函数使用的是什么排序

考察企业：
- 中望 C++软开

## 3.24 unordered_map和map有什么区别
...
## 3.25 迭代器的原理？为什么有了指针还要迭代器？

考察企业：
- 中望 C++软开

## 3.26 讲一讲vector和list的区别
...
## 3.29 讲一讲lambda表达式的原理

考查企业：
- 理想汽车 系统软件开发

## 3.30 lambda函数中捕获的变量存到了哪里

考察企业：
- 理想汽车 系统软件开发

## 3.31 讲一讲设计模式、以及什么是单例模式

考察企业：
- 旷视科技 自动驾驶部署优化


## 3.32 讲一下extern C及其作用
