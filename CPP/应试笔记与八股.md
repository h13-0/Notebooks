...
1. C语言关键字被定义在C11附录的A.1.2，主要有如下的关键字：
	1. 
...
2. 虚函数主要用于让子类<font color="#c00000">可选地</font>重写某一虚函数。若子类不重写，则默认使用父类的虚函数。
3. 纯虚函数主要用于让子类<font color="#c00000">强制地</font>重写某一纯虚函数。若子类不重写，则此时子类<font color="#c00000">仍是抽象类</font>，<font color="#c00000">无法实例化</font>。
