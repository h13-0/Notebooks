...
### 3.13 讲一讲构造函数有哪几种，分别在什么场景下会使用

考查企业：
- 商汤科技 嵌入式

### 3.14 返回值可以作为重载的区分条件吗

考察企业：
- 中望 C++软开

### 3.15 const和非const形参能作为重载的区分条件吗

考察企业：
- 中望 C++软开


### 3.16 引用计数有没有可能无法清零？如何解决循环引用的问题？

考察企业：
- 中望 C++软开

### 3.17 STL中的sort函数使用的是什么排序

考察企业：
- 中望 C++软开

### 3.18 unordered_map和map有什么区别
...
### 3.19 迭代器的原理？为什么有了指针还要迭代器？

考察企业：
- 中望 C++软开

### 3.20 讲一讲vector和list的区别
