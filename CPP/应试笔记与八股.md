...
### 1.10 讲一讲常用的三种退出循环的方式

break、continue、goto的区别


### 1.11 C语言标识符(Identifiers)规则
...
### 1.19 print函数和puts函数的区别



### 1.20 讲一讲malloc、realloc、calloc的区别和用法


### 1.21 讲一讲存储类型(auto、static、extern、register)
