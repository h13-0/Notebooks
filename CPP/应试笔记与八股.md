...
## 2.46 [TODO]讲一讲存储类型(auto、static、extern、register)
...
## 2.54 为什么在C语言中，一定要用unsigned char表示byte而非signed char或char
...
## 2.55 若Makefile中，头文件被修改，再次make会发生什么
...
## 2.62 void* 类型的指针作用是什么，相比于char* 、int* 等有什么优势？

考查企业：
- 影石 嵌入式


## 2.63 static和全局变量分别存储在哪里

考查企业：
- 禾塞科技 嵌入式

## 2.64 讲一下volatile关键字的作用
...
## 3.19 share_ptr中哪些是线程安全的

考察企业：
- 理想汽车 系统软件开发

## 3.20 share_ptr的计数器存放在哪里
...
## 3.24 为什么要实现拷贝构造？讲一讲深拷贝和浅拷贝的区别

考察企业：
- 开立医疗 C++开发

## 3.25 返回值可以作为重载的区分条件吗

考察企业：
- 中望 C++软开

## 3.26 const和非const形参能作为重载的区分条件吗

考察企业：
- 中望 C++软开


## 3.27 引用计数有没有可能无法清零？如何解决循环引用的问题？

考察企业：
- 中望 C++软开
- 理想汽车 系统软件开发

## 3.28 STL中的sort函数使用的是什么排序

考察企业：
- 中望 C++软开

## 3.29 unordered_map和map有什么区别
...
## 3.30 迭代器的原理？为什么有了指针还要迭代器？

考察企业：
- 中望 C++软开

## 3.31 讲一讲vector和list的区别
...
## 3.34 讲一讲lambda表达式的原理

考查企业：
- 理想汽车 系统软件开发

## 3.35 lambda函数中捕获的变量存到了哪里

考察企业：
- 理想汽车 系统软件开发

## 3.36 讲一讲设计模式、以及什么是单例模式

考察企业：
- 旷视科技 自动驾驶部署优化


## 3.37 讲一下extern C及其作用
