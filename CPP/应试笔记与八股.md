...
| 访问方式                | `E1[E2]` <span style="background:#fff88f"><font color="#c00000">的本质为</font></span> `(*((E1) + (E2)))` ，<font color="#c00000">允许</font> `*(a + offset)` 访问。<br> | 但是<font color="#c00000">不允许</font>指针 `a[offset]` 访问          |
