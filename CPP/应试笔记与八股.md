...
## 3.15 讲一讲动态多态的实现原理，虚表和虚指针存放在哪里

考察企业：
- 中望 C++软开

## 3.16 讲一讲智能指针，为什么要有智能指针
...
## 3.18 share_ptr中哪些是线程安全的

考察企业：
- 理想汽车 系统软件开发

## 3.19 share_ptr的计数器存放在哪里
...
## 3.23 为什么要实现拷贝构造？讲一讲深拷贝和浅拷贝的区别

考察企业：
- 开立医疗 C++开发

## 3.24 返回值可以作为重载的区分条件吗

考察企业：
- 中望 C++软开

## 3.25 const和非const形参能作为重载的区分条件吗

考察企业：
- 中望 C++软开


## 3.26 引用计数有没有可能无法清零？如何解决循环引用的问题？

考察企业：
- 中望 C++软开
- 理想汽车 系统软件开发

## 3.27 STL中的sort函数使用的是什么排序

考察企业：
- 中望 C++软开

## 3.28 unordered_map和map有什么区别
...
## 3.29 迭代器的原理？为什么有了指针还要迭代器？

考察企业：
- 中望 C++软开

## 3.30 讲一讲vector和list的区别
...
## 3.33 讲一讲lambda表达式的原理

考查企业：
- 理想汽车 系统软件开发

## 3.34 lambda函数中捕获的变量存到了哪里

考察企业：
- 理想汽车 系统软件开发

## 3.35 讲一讲设计模式、以及什么是单例模式

考察企业：
- 旷视科技 自动驾驶部署优化


## 3.36 讲一下extern C及其作用
