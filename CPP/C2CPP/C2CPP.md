...
##### 4.2.7.2.2 清空容器(clear)

```CPP
void clear() noexcept;
```

##### 4.2.7.2.3 插入元素(insert)
...
###### 4.2.7.2.3.4 带位置提示的插入

##### 4.2.7.2.4 删除元素(erase)

###### 4.2.7.2.4.1 通过key值删除
