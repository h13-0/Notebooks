...
###### 3.1.3.2.1 VFS open请求

在设备被VFS打开时，其会经过如下的逻辑：
- 
...
###### 3.1.3.3.1 向video_device中添加/获取驱动私有数据
...
###### 3.1.3.3.2 获取file结构体中的video_device指针
...
##### 3.1.3.4 设备类型(enum vfl_devnode_type) ^4ac1hk
