...
| ------------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `name`              |                       | 设备名称                                                                                                                                                                      |
| `vfl_type`          | 驱动手动配置                | 常见设备类型举例(详见[[V4L2#^4ac1hk\|设备类型枚举]])：<br>- `VFL_TYPE_VIDEO` 视频输入输出设备(`/dev/video0`)<br>- `VFL_TYPE_RADIO` 无线电调谐器(`/dev/radiox`)<br>- `VFL_TYPE_VBI` 垂直消隐数据设备(`/dev/vbi0`) |
